...
class History(db.Model):
    ...
    activity_key = db.Column(db.Integer, db.ForeignKey("activity.key"))
    last_clicked = db.Column(db.DateTime)

    def __repr__(self):
        return f'<User_History user_id={self.user_id} history_id={self.history_id}, activity_key={self.activity_key}, last_clicked={self.last_clicked}>'
...
class Activity(db.Model):
    ...
    # Named key instead of activity_id / id, since api I am using uses 'key'
